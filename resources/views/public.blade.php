<x-app-layout>
    <section class="flex flex-col items-center justify-between relative">
        <div class="public__scroller min-w-48 max-w-5xl h-[75vh] overflow-scroll bg-slate-800 mx-auto rounded-2xl mt-10">
        ...
        <form method="POST" action="/chat/store" class="flex min-w-48 w-full max-w-5xl justify-between fixed bottom-0 mb-5 h-[10%]">
            @csrf
